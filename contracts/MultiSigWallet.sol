...
contract MultiSigWallet {
    ...
    function executeTransaction(uint transactionId) 
        ...
        if (isConfirmed(transactionId)) {
            ...
            txn.executed = true;
            bytes memory dataString = bytes(txn.data);
            if (external_call(txn.destination, txn.value, dataString.length, txn.data))
    ...
    function external_call(address destination, uint value, uint dataLength, string memory data) private returns (bool) {
        bool result;
        assembly {
