...
async function deployLgumTokenContract(){
    ...
    var filename = __dirname + "/build/contracts/LedgeriumToken.json";
    var value = utils.readSolidityContractJSON(filename);
    if(value.length <= 0)
        return;
    
    var deployedLgumTokenAddress;
    if(!usecontractconfigFlag){
        ...
        //var deployedLgumTokenAddress = "0x0000000000000000000000000000000000002020";
        ...
        deployedLgumTokenAddress = transactionHash.contractAddress;
        global.deployedLgumTokenAddress = deployedLgumTokenAddress;
        console.log("LgumToken deployedAddress ", deployedLgumTokenAddress);

        utils.writeContractsINConfig("LgumToken",deployedLgumTokenAddress);
    }
    else{
        deployedLgumTokenAddress = utils.readContractFromConfigContracts("LgumToken");
    }    
    
    var LgumToken = new web3.eth.Contract(JSON.parse(value[0]),deployedLgumTokenAddress);
    global.LgumToken = LgumToken;
