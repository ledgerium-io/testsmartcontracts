...
async function deployGreeterPrivate (toPrivatePort,toPort1,otherPort1,otherPort2) {
    ...
    //fromPubKey = "Qm0SXQIIUIyGFTuDRlA/alnGHIuddBjeqVrMzwzCmM="; 
    //toPubKey = "Sj0wJqOPss1CJtvsUaMlc8fvbwH99EIyzOIm07Mxxg0=";
    // const host1 = "178.128.235.84";
    // const host2 = "138.68.62.196";
    // const host3 = "134.209.191.107";
    // const host4 = "157.230.244.236";
    // const h1 = "http://" + host1 + ":" + port;
    // const h2 = "http://" + host2 + ":" + toPort1;
    // const h3 = "http://" + host3 + ":" + otherPort1;
    // const h4 = "http://" + host4 + ":" + otherPort2;
    // //const h5 = "http://" + host5 + ":" + otherPort3;
...
async function getSimpleStorageValues(deployedAddressSimpleStorage) {
    ...
    //const contract5 = new web35.eth.Contract(JSON.parse(value[0]),deployedAddressSimpleStorage);
    // const c6 = new w6.eth.Contract(abi,addr);
    // const c7 = new w7.eth.Contract(abi,addr);
    ...
    //contract5.methods.get().call().then(console.log).catch((err)=>{console.log("err 5")});
    // c6.methods.get().call().then(console.log).catch((err)=>{console.log("err 6")});
    // c7.methods.get().call().then(console.log).catch((err)=>{console.log("err 7")});
}