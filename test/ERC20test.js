        ...
        describe('when the spender has enough approved balance', function () {
          ...
          describe('when the owner has enough balance', function () {
            ...
            it('decreases the spender allowance', async function () {
              ...
              var transactionObject  = await utils.sendMethodTransaction(spender,deployedERC20MockAddress,encodedABI,privateKey[spender],web3,0);
          ...
          describe('when the owner does not have enough balance', function () {
            ...
            it('reverts', async function () {
              ...
              var encodedABI = (await this.token.methods.transferFrom(owner, to , amount)).encodeABI();
              var transactionObject  = utils.sendMethodTransaction(spender,deployedERC20MockAddress,encodedABI,privateKey[spender],web3,0);
        ...
        function shouldDecreaseApproval (amount) {
          ...
          describe('when the spender had an approved amount', function () {
            ...
            it('emits an approval event', async function () {
              ...
              var logs = this.token.getPastEvents('Approval');
    ...
    describe('_mint', function () {
      ...
      describe('for a non null account', function () {
        beforeEach('minting', async function () {
          ...
          var encodedABI = await this.token.methods.mint(recipient, amount).encodeABI();
          var transactionObject = utils.sendMethodTransaction(owner,deployedERC20MockAddress,encodedABI,privateKey[owner],web3,0);
        ...
        it('emits Transfer event', async function () {
          ...
          event.returnValues.value.should.be.bignumber.equal(amount);
        ...
        const describeBurn = function (description, amount) {
          describe(description, function () {
            beforeEach('burning', async function () {
              ...
              var encodedABI = await this.token.methods.burn(owner, amount).encodeABI();
              var transactionObject = utils.sendMethodTransaction(owner,deployedERC20MockAddress,encodedABI,privateKey[owner],web3,0);
          ...
          const describeBurnFrom = function (description, amount) {
            describe(description, function () {
              beforeEach('burning', async function () {
                ...
                var ret = await this.token.methods.burnFrom(owner, amount).encodeABI();
                var transactionObject = await utils.sendMethodTransaction(owner,deployedERC20MockAddress,encodedABI,privateKey[owner],web3,0);
